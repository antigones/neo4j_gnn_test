...
hsk5_word_list = []
hsk5_file_map = {}
with open("HSK3_freqorder.txt", 'r',encoding='utf8') as csvfile:
...
for word in hsk5_word_list:
    ...
    for hanzi in word:
        ...
        if "etymology" in dict_entry_for_hanzi.keys():
            eti = dict_entry_for_hanzi["etymology"]
            hanzi_type = eti["type"]
            if hanzi_type == "pictophonetic":
